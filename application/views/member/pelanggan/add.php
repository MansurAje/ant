    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url('admin/pelanggan/doAdd/')?>" role="form" enctype="multipart/form-data"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="nama" value="" placeholder="Isi Nama pelanggan" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="pelanggan_notelp" value="" placeholder="Isi No Telepon" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
