    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
                ...
                <div class="ace-settings-box clearfix" id="ace-settings-box">
                    <div class="pull-left width-50">
                        ...
                        <div class="ace-settings-item">
                            <div class="pull-left">
                                <select id="skin-colorpelanggan_notelpker" class="hide">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url('admin/pelanggan/doUpdate/'.$this->uri->segment(4))?>" role="form" enctype="multipart/form-data"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="nama" value="<?php echo $detailData->pelanggan_name ?>" placeholder="Isi Nama pelanggan" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="pelanggan_notelp" value="<?php echo $detailData->pelanggan_notelp ?>" placeholder="Isi Nama pelanggan" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
...
<?php
$explode	= explode(",",$detailData->pelanggan_latlng);
$lat 		= $explode[0];
$lng 		= $explode[1];
?>
<script>
