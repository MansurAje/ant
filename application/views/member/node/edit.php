    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url('admin/node/doUpdate/'.$this->uri->segment(4))?>" role="form" enctype="multipart/form-data"> 
                       <?php 
...
<?php
$explode	= explode(",",$detailData->node_latlng);
$lat 		= $explode[0];
$lng 		= $explode[1];
?>
<script>
