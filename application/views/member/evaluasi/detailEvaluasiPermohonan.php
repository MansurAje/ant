    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url('admin/evaluasi/permohonan') ?>">Data Permohonan</a>
                </li>
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" role="form" name="myform" action="<?php echo base_url('admin/evaluasi/action/'.$id); ?>" enctype="multipart/form-data"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                                <button type="submit" name="evalueasi" class="btn btn-info" value="evaluasi">
