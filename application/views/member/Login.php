                        ...
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="red">Ant Colony</span>
                                    <span class="grey" id="id-text2"></span>
                                </h1>
                                <h4 class="blue" id="id-company-text">&copy; <?php echo $established; ?></h4>
                            </div>
                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
											...
											<?php }elseif($this->session->flashdata("RegisterBerhasil") == "Ya"){ ?>
                                            <div class="alert alert-success">
                                                <strong>SUCCESS!</strong> Register Berhasil, Silahkan Login!
                                            </div>
											<?php }elseif($this->session->flashdata("RegisterGagal") == "Ya"){ ?>
											<div class="alert alert-danger">
                                                <strong>ERROR!</strong> register gagal, silakan coba kembali
                                            </div>
											<?php } ?>
                                ...
                                <div id="signup-box" class="signup-box widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <form method="POST" action="<?php echo base_url('admin/login/doRegister') ?>">
                                                <fieldset>
													<label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
