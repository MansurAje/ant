    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" role="form" name="myform" action="<?php echo base_url('admin/approval/action/'.$id); ?>" enctype="multipart/form-data"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                                <button type="submit" name="approve" class="btn btn-info" value="approve">
